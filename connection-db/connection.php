...
$answer=$_POST['answer'];
$select = mysqli_query($conn, "SELECT * FROM `demo` WHERE `email` = '".$email."'");
...
$sql="INSERT INTO `demo`(`fname`, `lname`, `email`, `img`, `pswd`, `options`, `answer`) VALUES ('$fname','$lname','$email','$file','$password','$option','$answer')";
